package cn.wizzer.app.web.modules.controllers.platform.mt;
...
public class MtUnitController {
    ...
    @Inject
    @Reference
    private MtUnitService sysUnitService;
    @Inject
    ...
    public Object addDo(@Param("..") Mt_unit unit, @Param("parentId") String parentId, HttpServletRequest req) {
        try {
    ...
    public Object edit(String id, HttpServletRequest req) {
        Mt_unit unit = sysUnitService.fetch(id);
        if (unit != null) {
    ...
    public Object editDo(@Param("..") Mt_unit unit, @Param("parentId") String parentId, HttpServletRequest req) {
        try {
            unit.setOpBy(StringUtil.getPlatformUid());
    ...
    public Object tree(@Param("pid") String pid) {
        List<Mt_unit> list = new ArrayList<>();
        if (shiroUtil.hasRole("sysadmin")) {
            Cnd cnd = Cnd.NEW();
